...
?>
	<div <?php post_class(apply_filters('mptt_main_wrapper_class', 'mptt-main-wrapper container content-area')) ?>>
		<div class="<?php echo apply_filters('mptt_event_template_content_class', 'mptt-content') ?>">
			<?php
				 ...
				 */
				remove_action('mptt_event_item_content', 'mptt_event_template_content_title', 10);				
				remove_action('mptt_event_item_content', 'mptt_event_template_content_thumbnail', 20);
				remove_action('mptt_event_item_content', 'mptt_event_template_content_time_title', 40);
				remove_action('mptt_event_item_content', 'mptt_event_template_content_title', 40);
				remove_action( 'mptt_event_item_content', 'mptt_event_template_content_comments', 60 );									
				add_action('mptt_event_item_content', 'mptt_event_template_content_thumbnail_custom', 25);	
...
function mptt_event_template_content_thumbnail_custom(){
