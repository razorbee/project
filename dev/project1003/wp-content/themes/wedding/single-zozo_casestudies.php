							...
							<div id="casestudies-content-wrap" class="casestudies-single clearfix">										
								...
								<div <?php post_class(); ?> id="casestudies-<?php the_ID(); ?>">
									...
									<?php if( $zozo_casestudies_gallery != '' ) {
										...
										if( wedding_get_theme_option( 'zozo_casestudy_citems' ) != '' ) {



											$gallery_attr .= ' data-items=' . wedding_get_theme_option( 'zozo_casestudy_citems' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_citems_scroll' ) != '' ) {



											$gallery_attr .= ' data-slideby=' . wedding_get_theme_option( 'zozo_casestudy_citems_scroll' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_ctablet' ) != '' ) {



											$gallery_attr .= ' data-items-tablet=' . wedding_get_theme_option( 'zozo_casestudy_ctablet' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cmobile_land' ) != '' ) {



											$gallery_attr .= ' data-items-mobile-landscape=' . wedding_get_theme_option( 'zozo_casestudy_cmobile_land' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cmobile' ) != '' ) {



											$gallery_attr .= ' data-items-mobile-portrait=' . wedding_get_theme_option( 'zozo_casestudy_cmobile' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cautoplay' ) == 1 ) {
										...
										if( wedding_get_theme_option( 'zozo_casestudy_ctimeout' ) != '' ) {



											$gallery_attr .= ' data-autoplay-timeout=' . wedding_get_theme_option( 'zozo_casestudy_ctimeout' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cloop' ) == 1 ) {
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cmargin' ) != '' ) {



											$gallery_attr .= ' data-margin=' . wedding_get_theme_option( 'zozo_casestudy_cmargin' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cpagination' ) == 1 ) {
										...
										if( wedding_get_theme_option( 'zozo_casestudy_cnavigation' ) == 1 ) {
