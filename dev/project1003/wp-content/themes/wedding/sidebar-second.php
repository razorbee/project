...
$sidebar_widget = $choosed_layout = $layouts = $home_id = '';
	...
	if( is_archive() ) {
		...
		$choosed_layout = wedding_get_theme_option( 'zozo_blog_archive_layout' );
	...
	if( is_home() ) {
		...
		if( !$choosed_layout ) {
			...
			$choosed_layout = wedding_get_theme_option( 'zozo_blog_layout' );
	...
	if ( is_singular( 'post' ) ) {
		...
		if( !$choosed_layout ) {
			...
			$choosed_layout = wedding_get_theme_option( 'zozo_single_post_layout' );
	...
	if( !$choosed_layout ) {			
		...
		if( wedding_get_theme_option( 'zozo_layout' ) != '' ) {		
			...
			$choosed_layout = wedding_get_theme_option( 'zozo_layout' );
...
<div id="secondary-sidebar" class="secondary-sidebar sidebar <?php wedding_secondary_sidebar_classes(); ?>">
