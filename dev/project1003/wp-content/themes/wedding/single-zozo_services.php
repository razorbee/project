							...
							<div id="services-content-wrap" class="services-single clearfix">										
								...
								<div <?php post_class(); ?> id="services-<?php the_ID(); ?>">
									...
									<?php if( $zozo_services_gallery != '' ) {
										...
										if( wedding_get_theme_option( 'zozo_service_citems' ) != '' ) {



											$gallery_attr .= ' data-items=' . wedding_get_theme_option( 'zozo_service_citems' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_citems_scroll' ) != '' ) {



											$gallery_attr .= ' data-slideby=' . wedding_get_theme_option( 'zozo_service_citems_scroll' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_ctablet' ) != '' ) {



											$gallery_attr .= ' data-items-tablet=' . wedding_get_theme_option( 'zozo_service_ctablet' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_cmobile_land' ) != '' ) {



											$gallery_attr .= ' data-items-mobile-landscape=' . wedding_get_theme_option( 'zozo_service_cmobile_land' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_cmobile' ) != '' ) {



											$gallery_attr .= ' data-items-mobile-portrait=' . wedding_get_theme_option( 'zozo_service_cmobile' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_cautoplay' ) == 1 ) {
										...
										if( wedding_get_theme_option( 'zozo_service_ctimeout' ) != '' ) {



											$gallery_attr .= ' data-autoplay-timeout=' . wedding_get_theme_option( 'zozo_service_ctimeout' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_cloop' ) == 1 ) {
										...
										if( wedding_get_theme_option( 'zozo_service_cmargin' ) != '' ) {



											$gallery_attr .= ' data-margin=' . wedding_get_theme_option( 'zozo_service_cmargin' ) . ' ';
										...
										if( wedding_get_theme_option( 'zozo_service_cpagination' ) == 1 ) {
										...
										if( wedding_get_theme_option( 'zozo_service_cnavigation' ) == 1 ) {
