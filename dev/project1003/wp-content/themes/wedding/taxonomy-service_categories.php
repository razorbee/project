			...
			<div class="zozo-row row">	
				...
				<div id="primary" class="content-area <?php wedding_primary_content_classes(); ?>">
					...
					<div id="content" class="site-content">
						...
						if( wedding_get_theme_option( 'zozo_service_archive_count' ) != '' ) {



							$posts = wedding_get_theme_option( 'zozo_service_archive_count' );
						...
						if( wedding_get_theme_option( 'zozo_service_archive_columns' ) != '' ) {



							$grid_columns = wedding_get_theme_option( 'zozo_service_archive_columns' );
						...
						if( $query->have_posts() ):
									...
									<div id="services-<?php the_ID(); ?>" <?php post_class('services-item'); ?>>
										...
										<div class="services-content-wrapper">
											...
											echo '<div class="services-excerpts"><p>';
												...
												echo wedding_shortcode_stripped_excerpt( get_the_excerpt(), 10 );
											...
											echo '<a href="'. esc_url( get_permalink() ) .'" class="btn btn-more" title="'. esc_html( get_the_title() ) .'">'. esc_html__('Read more', 'wedding') .'</a>'; ?>
							...
							echo wedding_pagination( $query->max_num_pages, '' );
