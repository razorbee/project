			...
			<div class="zozo-row row">	
				...
				<div id="primary" class="content-area <?php wedding_primary_content_classes(); ?>">
					...
					<div id="content" class="site-content">
						...
						if( wedding_get_theme_option( 'zozo_portfolio_archive_count' ) != '' ) {



							$posts = wedding_get_theme_option( 'zozo_portfolio_archive_count' );
						...
						if( wedding_get_theme_option( 'zozo_portfolio_archive_layout' ) != '' ) {



							$style = wedding_get_theme_option( 'zozo_portfolio_archive_layout' );
						...
						if( wedding_get_theme_option( 'zozo_portfolio_archive_columns' ) != '' ) {



							$grid_columns = wedding_get_theme_option( 'zozo_portfolio_archive_columns' );
						...
						if( wedding_get_theme_option( 'zozo_portfolio_archive_gutter' ) != '' ) {



							$grid_gutter = wedding_get_theme_option( 'zozo_portfolio_archive_gutter' );
							...
							echo '<div class="zozo-portfolio-grid-wrapper zozo-isotope-grid-system clearfix">';
								...
								while ( $query->have_posts() ): $query->the_post();
									...
									if( isset( $grid_columns ) && $grid_columns == '2' ) {
										...
										$image_size = 'wedding-portfolio-large';
									...
									$media_output = wedding_portfolio_media_output( $post->ID, $style, $grid_columns, $term_id ); 
									...
									$media_icon_output = wedding_portfolio_media_icon_output( $post->ID, $term_id ); ?>
										...
										<div class="portfolio-content">
											...
											echo '<div class="portfolio-image-overlay-wrapper">';
												...
												if( isset( $media_output ) && $media_output != '' ) {
													...
													echo wedding_portfolio_media_output( $post->ID, $style, $grid_columns, $term_id );
											...
											if( isset( $style ) && $style == 'classic' ) {
												...
												echo '<div class="portfolio-mask overlay-mask position-center">';
													...
													echo '<ul class="overlay-buttons fade-up">';					
														...
														if( isset( $media_icon_output ) && $media_icon_output != '' ) {
															...
															echo wedding_portfolio_media_icon_output( $post->ID, $term_id );
												...
												echo '<div class="portfolio-inner-wrapper">';
													...
													echo '<div class="portfolio-inner-content">';
														...
														echo '<p>' . wedding_shortcode_stripped_excerpt( get_the_excerpt(), 15 ) . '</p>';
														...
														echo '<a href="'. get_permalink() .'" class="btn btn-more" title="'.get_the_title().'">'. esc_html__('Read more', 'wedding') .'</a>';
												...
												echo '<div class="portfolio-mask overlay-mask position-center">';
													...
													echo '<div class="portfolio-title">';
														...
														if( isset( $grid_columns ) && $grid_columns == 4 ) {
															...
															echo '<p>' . wedding_shortcode_stripped_excerpt( get_the_excerpt(), 5 ) . '</p>';
															...
															echo '<p>' . wedding_shortcode_stripped_excerpt( get_the_excerpt(), 8 ) . '</p>';
								...
								<?php echo wedding_pagination( $query->max_num_pages, '' ); ?>
