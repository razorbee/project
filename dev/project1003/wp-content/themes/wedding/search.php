...
$original_layout = wedding_get_theme_option( 'zozo_search_page_type' );



$grid_columns = wedding_get_theme_option( 'zozo_search_grid_columns' );
					...
					<div id="content" class="site-content">
						...
						<?php if ( have_posts() ): ?>
							...
							<div class="zozo-search-page search-page-form">
								...
								<h4><?php esc_html_e( 'New Search', 'wedding' ); ?></h4>
								...
								<p><?php esc_html_e('If you didn\'t find what you were looking for, try another search', 'wedding'); ?></p>
								...
								<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="search-form search-page">
									...
									<div class="input-group">
										...
										<input type="text" value="" name="s" class="form-control" placeholder="<?php esc_html_e('Search...', 'wedding'); ?>" />
										...
										<span class="input-group-btn">
											...
											<button class="btn btn-search" type="submit"><?php esc_html_e('Go', 'wedding'); ?></button>
								...
								<div class="post-inner-wrapper">
									...
									<div class="posts-content-container">
										...
										<div class="entry-header">			   
											...
											<h1 class="entry-title"><?php esc_html_e('Nothing Found', 'wedding'); ?></h1>			



											<p><?php esc_html_e('Sorry, but no posts matched your search terms. Please try again with different keywords.', 'wedding'); ?></p>
										...
										<div class="entry-content">
											...
											<h4><?php esc_html_e('Try New Search', 'wedding'); ?></h4>
