...
jQuery(document).ready(function( $ ){
	...
	//Init vars
	var ajaxRequestUrl 		= WeddingItemRatingsVars.ajaxUrl;
	var nonceValue			= WeddingItemRatingsVars.ajaxNonce;
	var rateUpdateAction	= WeddingItemRatingsVars.rateUpdateAction;
	var pluginConfigOptions	= WeddingItemRatingsVars.pluginConfigOptions;
	var ajaxUpdateErrorText	= WeddingItemRatingsVars.ajaxRateUpdateErrorText;
