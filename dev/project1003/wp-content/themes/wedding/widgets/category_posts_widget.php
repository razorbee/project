...
class Wedding_Category_Posts_Widget extends WP_Widget {
...

	{
		...
		$widget_options = array('classname' => 'zozo_category_posts_widget', 'description' => esc_html__( 'Displays category posts.', 'wedding' ));
		...
		parent::__construct('zozo_category_posts-widget', esc_html__( 'Category Posts', 'wedding' ), $widget_options, $control_options);
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_button') ); ?>"><?php _e('Show Button', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('button_text') ); ?>"><?php _e('Button Text:', 'wedding'); ?></label>
...
function wedding_category_posts_load()
...

{
	...
	register_widget('Wedding_Category_Posts_Widget');
...
add_action('widgets_init', 'wedding_category_posts_load');
