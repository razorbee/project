...
class Wedding_Popular_Posts_Widget extends WP_Widget {
...

	{
		...
		$widget_options = array('classname' => 'zozo_popular_posts_widget', 'description' => esc_html__( 'Displays latest posts based on categories.', 'wedding' ));
		...
		parent::__construct('zozo_popular_posts-widget', esc_html__( 'Popular Posts', 'wedding' ), $widget_options, $control_options);
					...
					<li class="posts-item clearfix">
						...
						<div class="latest-post-content">
							...
							<?php if( $show_date == 'on' ) { ?>
								...
								<div class="entry-date posted-date"><i class="simple-icon icon-calendar"></i> <?php the_time( wedding_get_theme_option( 'zozo_blog_date_format' ) ); ?></div>
...

	{
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('categories') ); ?>"><?php _e('Choose Category:', 'wedding'); ?></label>			
			...
			<?php $args = array(
					...
					'show_option_all'    => esc_html__( 'All Categories', 'wedding' ),
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('posts_count') ); ?>"><?php _e('Number of posts to show:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_date') ); ?>"><?php _e('Show Date', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_excerpt') ); ?>"><?php _e('Show Excerpt', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('show_thumb') ); ?>"><?php _e('Show Thumbnail Image', 'wedding'); ?></label>
...
function wedding_popular_posts_load()
...

{
	...
	register_widget('Wedding_Popular_Posts_Widget');
...
add_action('widgets_init', 'wedding_popular_posts_load');