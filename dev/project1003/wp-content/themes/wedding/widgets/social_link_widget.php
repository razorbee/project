...
class Wedding_Social_Link_Widget extends WP_Widget {
	...
	{				
		...
		$widget_options = array('classname' => 'zozo_social_link_widget', 'description' => esc_html__( 'Display your social links.', 'wedding' ));
		...
		parent::__construct('zozo_social_link_widget-widget', esc_html__( 'Social Links', 'wedding' ), $widget_options, $control_options);
...

	{
		...
		$defaults = array('title' => '', 'align' => '', 'icon_size' => '', 'icon_type' => '', 'facebook' => '', 'twitter' => '', 'pinterest' => '', 'googleplus' => '', 'linkedin' => '', 'youtube' => '', 'rss' => '', 'tumblr' => '', 'dribbble' => '', 'flickr' => '', 'instagram' => '', 'vimeo' => '', 'skype' => '', 'yahoo' => '' );
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('align') ); ?>"><?php _e('Alignment:', 'wedding'); ?></label>
			...
			<select id="<?php echo esc_attr( $this->get_field_id('align' )); ?>" name="<?php echo esc_attr( $this->get_field_name('align') ); ?>" class="widefat" style="width:100%;">
				...
				<option value="left" <?php echo selected(esc_attr($instance['align']), 'left', false); ?>><?php _e('Left', 'wedding'); ?></option>



				<option value="right" <?php echo selected(esc_attr($instance['align']), 'right', false); ?>><?php _e('Right', 'wedding'); ?></option>



				<option value="center" <?php echo selected(esc_attr($instance['align']), 'center', false); ?>><?php _e('Center', 'wedding'); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('icon_size') ); ?>"><?php _e('Icon Size:', 'wedding'); ?></label>
			...
			<select id="<?php echo esc_attr( $this->get_field_id('icon_size' )); ?>" name="<?php echo esc_attr( $this->get_field_name('icon_size') ); ?>" class="widefat" style="width:100%;">
				...
				<option value="normal" <?php echo selected(esc_attr($instance['icon_size']), 'normal', false); ?>><?php _e('Normal', 'wedding'); ?></option>



				<option value="large" <?php echo selected(esc_attr($instance['icon_size']), 'large', false); ?>><?php _e('Large', 'wedding'); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('icon_type') ); ?>"><?php _e('Icon Type:', 'wedding'); ?></label>
			...
			<select id="<?php echo esc_attr( $this->get_field_id('icon_type' )); ?>" name="<?php echo esc_attr( $this->get_field_name('icon_type') ); ?>" class="widefat" style="width:100%;">
				...
				<option value="circle" <?php echo selected(esc_attr($instance['icon_type']), 'circle', false); ?>><?php _e('Circle', 'wedding'); ?></option>



				<option value="square" <?php echo selected(esc_attr($instance['icon_type']), 'square', false); ?>><?php _e('Square', 'wedding'); ?></option>



				<option value="rounded" <?php echo selected(esc_attr($instance['icon_type']), 'rounded', false); ?>><?php _e('Rounded', 'wedding'); ?></option>



				<option value="transparent" <?php echo selected(esc_attr($instance['icon_type']), 'transparent', false); ?>><?php _e('Transparent', 'wedding'); ?></option>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e('Facebook URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e('Twitter URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('pinterest') ); ?>"><?php _e('Pinterest URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('googleplus') ); ?>"><?php _e('Google Plus URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e('Linkedin URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e('Youtube URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('rss') ); ?>"><?php _e('Rss URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tumblr') ); ?>"><?php _e('Tumblr URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('dribbble') ); ?>"><?php _e('Dribbble URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('flickr') ); ?>"><?php _e('Flickr URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e('Instagram URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('vimeo') ); ?>"><?php _e('Vimeo URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('skype') ); ?>"><?php _e('Skype URL:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('yahoo') ); ?>"><?php _e('Yahoo URL:', 'wedding'); ?></label>
...
function wedding_social_link_load()
...

{
	...
	register_widget('Wedding_Social_Link_Widget');
...
add_action('widgets_init', 'wedding_social_link_load');
