...
class Wedding_Mailchimp_Form_Widget extends WP_Widget {	
...

	{
		...
		$widget_options = array('classname' => 'zozo_mailchimp_form_widget', 'description' => esc_html__( 'Displays subscribe form for Mailchimp Lists.', 'wedding' ));
		...
		parent::__construct('zozo_mailchimp_form_widget-widget', esc_html__( 'Mailchimp Subscribe Form', 'wedding' ), $widget_options, $control_options);
...

	{
		...
		$description = !empty($instance['description']) ? $instance['description'] : esc_html__( '', 'wedding' );
...

	{
		...
		$lists = wedding_get_mailing_lists_format(); ?>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('description') ); ?>"><?php _e('Description:', 'wedding'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('mailchimp_list') ); ?>"><?php _e( 'Choose Mailing List:', 'wedding' ); ?></label>			
...
function wedding_mailchimp_form_load()
...

{
	...
	register_widget('Wedding_Mailchimp_Form_Widget');
...
add_action('widgets_init', 'wedding_mailchimp_form_load');
