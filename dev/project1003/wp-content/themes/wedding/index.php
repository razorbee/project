...
$original_layout = wedding_get_theme_option( 'zozo_blog_type' );



$grid_columns = wedding_get_theme_option( 'zozo_blog_grid_columns' );
			...
			<div class="zozo-row row">
				...
				<div id="primary" class="content-area <?php wedding_primary_content_classes(); ?>">
					...
					<div id="content" class="site-content">	
						...
						if( wedding_get_theme_option( 'zozo_show_blog_featured_slider' ) == 1 && wedding_get_theme_option( 'zozo_featured_slider_type' ) == 'above_content' ) {
