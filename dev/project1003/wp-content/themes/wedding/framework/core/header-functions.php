 ...
 *	wedding_secondary_menu()



 *  wedding_footer_hidden_wrapper_start()



 *  wedding_footer_hidden_wrapper_end()



 *	wedding_header_wrapper()



 *  wedding_header_top_bar()



 *  wedding_header_layout()



 *  wedding_header_elements_wrapper()



 *  wedding_header_elements()



 *  wedding_header_toggle_elements()



 *  wedding_header_contact_info()



 *  wedding_woo_get_cart()



 *  wedding_top_bar_menu()
 ...
 *  wedding_main_right_menu()



 *  wedding_main_mobile_menu()
 ...
 *	wedding_header_top_anchor()



 *  wedding_mobile_header_wrapper()



 *  wedding_mobile_header_layout()



 *	wedding_page_slider_wrapper()



 *	wedding_featured_post_slider()
...
if ( ! function_exists( 'wedding_page_loader' ) ) {



	function wedding_page_loader() {
		...
		if( wedding_get_theme_option( 'zozo_disable_page_loader' ) != 1 ) {



			$custom_loader_img = wedding_get_theme_option( 'zozo_page_loader_img' );
			...
			if( isset( $custom_loader_img ) && ( isset( $custom_loader_img['url'] ) && $custom_loader_img['url'] != '' ) ) {
				...
				echo '<div class="zozo-custom-loader"><img class="img-responsive custom-loader-img" src="' . esc_url( $custom_loader_img['url'] ) . '" alt="" width="'. esc_attr( $custom_loader_img['width'] ) .'" height="'. esc_attr( $custom_loader_img['height'] ) .'" /></div>' . "\n";
				...
				echo '<div class="zozo-custom-loader"><img class="img-responsive page-loader-img" src="' . esc_url( WEDDING_THEME_URL . '/images/page-loader.gif' ) . '" alt="" width="64" height="79" /></div>';
	...
	add_action( 'wedding_before_page_wrapper', 'wedding_page_loader', 5 );
...
if ( ! function_exists( 'wedding_header_wrapper' ) ) {



	function wedding_header_wrapper() {
		...
		if( isset( $header_layout ) && $header_layout == '' || $header_layout == 'default' ) {
			...
			$header_layout = wedding_get_theme_option( 'zozo_header_layout' );
		...
		if( isset( $header_skin ) && $header_skin == '' || $header_skin == 'default' ) {
			...
			$header_skin = wedding_get_theme_option( 'zozo_header_skin' );
		...
		if( isset( $header_menu_skin ) && $header_menu_skin == '' || $header_menu_skin == 'default' ) {
			...
			$header_menu_skin = wedding_get_theme_option( 'zozo_header_menu_skin' );
		...
		if( isset( $header_dropdown_menu_skin ) && $header_dropdown_menu_skin == '' || $header_dropdown_menu_skin == 'default' ) {
			...
			$header_dropdown_menu_skin = wedding_get_theme_option( 'zozo_dropdown_menu_skin' );
		...
		if( isset( $header_toggle_position ) && $header_toggle_position == '' || $header_toggle_position == 'default' ) {
			...
			$header_toggle_position = wedding_get_theme_option( 'zozo_header_toggle_position' );
		...
		if( isset( $show_header ) && $show_header == 'yes' ) { ?>
			...
			<div id="header" class="header-section type-<?php echo esc_attr( $header_type ); ?><?php echo esc_attr( $header_extra_class ); ?> header-layout-<?php echo esc_attr( $header_layout ); ?> header-skin-<?php echo esc_attr( $header_skin ); ?> header-<?php echo esc_attr( $header_transparency ); ?> header-dropdown-skin-<?php echo esc_attr( $header_dropdown_menu_skin ); ?>">
				...
				<?php }
					 ...
					 * @hooked - wedding_header_top_bar - 15
					...
					**/
					...
					do_action('wedding_header_section_start');
					...
					do_action('wedding_header_section_end');
	...
	add_action( 'wedding_header_wrapper_start', 'wedding_header_wrapper', 20 );
...
if ( ! function_exists( 'wedding_header_top_bar' ) ) {



	function wedding_header_top_bar() {
		...
		if( isset( $header_top_bar ) && $header_top_bar == '' || $header_top_bar == 'default' ) {
			...
			$header_top_bar = wedding_get_theme_option( 'zozo_enable_header_top_bar' );
		...
		if( isset( $header_type ) && $header_type != "header-10" ) {
			...
			if( isset($header_top_bar) && $header_top_bar == 'yes' ) {
				...
				$topbar_left_output = wedding_header_elements_wrapper( 'top-bar', 'left' );



				$topbar_right_output = wedding_header_elements_wrapper( 'top-bar', 'right' );
	...
	add_action( 'wedding_header_section_start', 'wedding_header_top_bar', 15 );
...
if ( ! function_exists( 'wedding_header_elements_wrapper' ) ) {



	function wedding_header_elements_wrapper( $type = '', $position = '', $header_type = '', $toggle_type = '', $only_search = '', $search_type = '' ) {
		...
		if( $type == 'top-bar' && $position == 'left' ) {
			...
			$topbar_config = wedding_get_theme_option( 'zozo_header_top_bar_left' );



			$topbar_text = wedding_get_theme_option( 'zozo_header_top_bar_left_text' );
			...
			$topbar_config = wedding_get_theme_option( 'zozo_header_top_bar_right' );



			$topbar_text = wedding_get_theme_option( 'zozo_header_top_bar_right_text' );
		...
		if( $type == 'main-bar' && ( $header_type == 'header-1' || $header_type == 'header-3' ) ) {
			...
			$mainbar_config = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_elements_config' );



			$mainbar_text = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_elements_text' );
			...
			if( $position == 'left' ) {
				...
				$mainbar_config = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_left_config' );



				$mainbar_text = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_left_text' );
				...
				$mainbar_config = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_right_config' );



				$mainbar_text = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_right_text' );
			...
			$mainbar_config = wedding_get_theme_option( 'zozo_header_right_alt_config' );



			$mainbar_text = wedding_get_theme_option( 'zozo_header_right_alt_text' );
		...
		if( $type == 'logo-bar' && ( $header_type == 'header-11' ) ) {
			...
			$logobar_config = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_logo_bar_config' );



			$logobar_text = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_logo_bar_text' );
		...
		if( $type == 'top-bar' ) {
			...
			if( ! empty( $topbar_config ) && isset( $topbar_config['enabled'] ) ) {
				...
				foreach( $topbar_config['enabled'] as $item_id => $item ) {
					...
					$topbar_output .= wedding_header_elements( $item_id, 'top-bar-item', $topbar_text );
			...
			if( $header_type == 'header-11' ) {
				...
				$mainbar_left_config = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_left_config' );



				$mainbar_right_config = wedding_get_theme_option( 'zozo_header_'. $header_number[1] .'_right_config' );
				...
				if( wedding_get_theme_option( 'zozo_header_search_type' ) == 1 && ( isset( $search_type ) && $search_type == 'toggle' ) ) {
					...
					if( array_key_exists( 'search-icon', $mainbar_config_common ) || array_key_exists( 'search-icon', $mainbar_left_config['enabled'] ) || array_key_exists( 'search-icon', $mainbar_right_config['enabled'] ) ) {
						...
						if( isset( $only_search ) && $only_search == 'yes' ) {
							...
							if( $header_type != 'header-9' && $header_type != 'header-10' ) {
								...
								$mainbar_output .= wedding_header_elements( 'toggle-search', 'main-bar-item', '', 'content' );
				...
				else if( wedding_get_theme_option( 'zozo_header_search_type' ) == 2 && ( isset( $search_type ) && $search_type == 'fullscreen' ) ) {
					...
					if( array_key_exists( 'search-icon', $mainbar_config_common ) || array_key_exists( 'search-icon', $mainbar_left_config['enabled'] ) || array_key_exists( 'search-icon', $mainbar_right_config['enabled'] ) ) {
						...
						if( isset( $only_search ) && $only_search == 'yes' ) {
							...
							$mainbar_output .= wedding_header_elements( 'fullscreen-search', 'main-bar-item', '', 'content' );
				...
				foreach( $mainbar_config['enabled'] as $item_id => $item ) {
					...
					if( isset( $only_search ) && $only_search == 'yes' ) {
						...
						if( $item_id == "search-icon" ) {
							...
							if( wedding_get_theme_option( 'zozo_header_search_type' ) == 1 ) {



								$mainbar_output .= wedding_header_elements( 'toggle-search', 'main-bar-item', '', 'icon' );



							} else if( wedding_get_theme_option( 'zozo_header_search_type' ) == 2 ) {



								$mainbar_output .= wedding_header_elements( 'fullscreen-search', 'main-bar-item', '', 'icon' );
								...
								$mainbar_output .= wedding_header_elements( 'main-search', 'main-bar-item' );
							...
							$mainbar_output .= wedding_header_elements( 'mobile-menu', 'main-bar-item' );
							...
							$mainbar_output .= wedding_header_elements( $item_id, 'main-bar-item', $mainbar_text );
			...
			if( ! empty( $logobar_config ) && isset( $logobar_config['enabled'] ) ) {
				...
				foreach( $logobar_config['enabled'] as $item_id => $item ) {
					...
					$logobar_output .= wedding_header_elements( $item_id, 'logo-bar-item', $logobar_text );
...
if ( ! function_exists( 'wedding_header_elements' ) ) {



	function wedding_header_elements( $element = '', $item_class = '', $shortcode_text = '', $search_type = '' ) {
		...
		if( $element == "contact-info" ) {
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-contact-info">'. wedding_header_contact_info() .'</div>' . "\n";
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-social"><div id="header-social-links" class="header-social">'. wedding_display_social_icons() .'</div></div>' . "\n";
			...
			if( WEDDING_WOOCOMMERCE_ACTIVE ) {			
				...
				$element_output .= '<div class="'. esc_attr( $item_class ) .' item-cart zozo-woo-cart-info">'. wedding_woo_get_cart() .'</div>' . "\n";
			...
			if( wedding_get_theme_option( 'zozo_enable_secondary_menu' ) == 1 ) {
			...
			if( wedding_get_theme_option( 'zozo_welcome_msg' ) != '' ) {



				$element_output .= '<div class="'. esc_attr( $item_class ) .' item-welcome-msg"><p class="welcome-msg">'. force_balance_tags( wedding_get_theme_option( 'zozo_welcome_msg' ) ) .'</p></div>' . "\n";
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-top-menu">'. wedding_top_bar_menu() .'</div>' . "\n";
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-main-mobile-menu">'. wedding_main_mobile_menu( 'primary' ) .'</div>';
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-main-right-menu">'. wedding_main_right_menu() .'</div>';
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-main-menu">'. wedding_main_menu() .'</div>';
			...
			$element_output .= '<div class="'. esc_attr( $item_class ) .' item-address-info">';
				...
				if( wedding_get_theme_option( 'zozo_header_address' ) != '' ) {



					$element_output .= '<div class="header-details-box"><div class="header-details-icon header-address-icon"><i class="simple-icon icon-pointer"></i></div><div class="header-details-info header-address">'. force_balance_tags( wedding_get_theme_option( 'zozo_header_address' ) ) .'</div></div>';
				...
				if( wedding_get_theme_option( 'zozo_header_business_hours' ) != '' ) {



					$element_output .= '<div class="header-details-box"><div class="header-details-icon header-business-icon"><i class="simple-icon icon-clock"></i></div><div class="header-details-info header-business-hours">'. force_balance_tags( wedding_get_theme_option( 'zozo_header_business_hours' ) ) .'</div></div>';
				...
				if( ( wedding_get_theme_option( 'zozo_header_phone' ) != '' ) || ( wedding_get_theme_option( 'zozo_header_email' ) != '' ) ) {



					$element_output .= '<div class="header-details-box"><div class="header-details-icon header-contact-icon"><i class="simple-icon icon-earphones-alt"></i></div><div class="header-details-info header-contact-details"><strong>'. force_balance_tags( wedding_get_theme_option( 'zozo_header_phone' ) ) .'</strong><span><a href="mailto:'.esc_attr( wedding_get_theme_option( 'zozo_header_email' ) ).'">'.esc_html( wedding_get_theme_option( 'zozo_header_email' ) ).'</a>' .'</span></div></div>';
...
if ( ! function_exists( 'wedding_header_contact_info' ) ) {



	function wedding_header_contact_info() {
		...
		$header_phone = wedding_get_theme_option( 'zozo_header_phone' );



		$header_email = wedding_get_theme_option( 'zozo_header_email' );
...
if ( ! function_exists( 'wedding_woo_get_cart' ) ) {



 function wedding_woo_get_cart() {
  ...
  if( ! $woocommerce->cart->cart_contents_count ) {
   ...
   $output .= '<div class="woo-cart-contents cart-empty-msg">';
    ...
    $output .= esc_html__('Your cart is currently empty', 'wedding');
   ...
   $output .= '<div class="woo-cart-contents">';
    ...
    foreach( $woocommerce->cart->cart_contents as $cart_item_key => $cart_item ) {
     ...
     $output .= apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove remove-cart-item" title="%s" data-cart_id="%s">&times;</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__('Remove this item', 'wedding'), $cart_item_key ), $cart_item_key );
    ...
    $output .= '<h5 class="cart-total">'. esc_html__('Total: ', 'wedding') .' '. wp_kses_post( $woocommerce->cart->get_cart_total() ) .'</h5>';
    ...
    $output .= '<div class="cart-link"><a class="btn btn-cart" href="'. get_permalink(get_option('woocommerce_cart_page_id')) .'" title="'. esc_html__('Cart', 'wedding') .'">'. esc_html__('View Cart', 'wedding') .'</a></div>';



    $output .= '<div class="checkout-link"><a class="btn btn-checkout" href="'. get_permalink(get_option('woocommerce_checkout_page_id')) .'" title="'. esc_html__('Checkout', 'wedding') .'">'. esc_html__('Checkout', 'wedding') .'</a></div>';
...
if ( ! function_exists( 'wedding_top_bar_menu' ) ) {



	function wedding_top_bar_menu() {
		...
		$top_menu_args = array(
			...
			'walker'         	=> new wedding_wp_bootstrap_navwalker(),



			'fallback_cb'    	=> 'wedding_wp_bootstrap_navwalker::fallback',
		...
		if ( function_exists( 'wp_nav_menu' ) ) {
			...
			if ( has_nav_menu( 'top-menu' ) ) {
				...
				$top_menu_output .= '<div class="no-menu">' . esc_html__( "Please assign a menu to the Top Bar Menu", "wedding" ) . '</div>';
...
if ( ! function_exists( 'wedding_main_menu' ) ) {



	function wedding_main_menu() {
		...
		if( wedding_get_theme_option( 'zozo_menu_separator' ) == 1 ) {
...
if ( ! function_exists( 'wedding_main_right_menu' ) ) {



	function wedding_main_right_menu() {
		...
		if( wedding_get_theme_option( 'zozo_menu_type' ) != 'standard' && wedding_get_theme_option( 'zozo_menu_type' ) == 'megamenu' ) {
...
if ( ! function_exists( 'wedding_main_mobile_menu' ) ) {



	function wedding_main_mobile_menu( $menu_type = '' ) {
		...
		if( isset( $menu_type ) && $menu_type == 'primary' ) {			
			...
			$mobile_menu_args = array(
				...
				'walker'         	=> new wedding_wp_bootstrap_mobile_navwalker(),



				'fallback_cb'    	=> 'wedding_wp_bootstrap_mobile_navwalker::fallback'
...
if ( ! function_exists( 'wedding_logo' ) ) {



	function wedding_logo( $logo_class = '', $logo_id = 'logo' ) {
		...
		$logo_opt = wedding_get_theme_option( 'zozo_logo' );
		...
		$retina_logo_opt = wedding_get_theme_option( 'zozo_retina_logo' );
		...
		$sticky_logo_opt = wedding_get_theme_option( 'zozo_sticky_logo' );
		...
		if( $logo_id == "mobile-logo" ) {
			...
			$mobile_logo_opt = wedding_get_theme_option( 'mobile_logo' );
...
if ( ! function_exists( 'wedding_mobile_header_wrapper' ) ) {



	function wedding_mobile_header_wrapper() {
		...
		$mobile_header_layout = wedding_get_theme_option( 'mobile_header_layout' );



		$mobile_top_text      = wedding_get_theme_option( 'mobile_top_text' );
		...
		if( isset( $show_header ) && $show_header == 'yes' ) { ?>
			...
			<div id="mobile-header" class="mobile-header-section header-skin-<?php echo esc_attr( $header_skin ); ?> header-mobile-<?php echo esc_attr( $mobile_header_layout ); ?>">
				...
				echo wedding_mobile_header_layout( $mobile_header_layout );
	...
	add_action( 'wedding_header_wrapper_start', 'wedding_mobile_header_wrapper', 15 ); 
...
if ( ! function_exists( 'wedding_mobile_header_layout' ) ) {



	function wedding_mobile_header_layout( $mobile_header_layout = '' ) {
		...
		$mobile_show_cart     		= wedding_get_theme_option( 'mobile_show_cart' );



		$mobile_show_search   		= wedding_get_theme_option( 'mobile_show_search' ); 
		...
		if( $mobile_header_layout == "right-logo" ) {
			...
			if( WEDDING_WOOCOMMERCE_ACTIVE && ( isset( $mobile_show_cart ) && $mobile_show_cart == 1 ) ) {
			...
			$mobile_header_output .= wedding_logo( 'logo-right', 'mobile-logo' );
			...
			$mobile_header_output .= wedding_logo( 'logo-center', 'mobile-logo' );
			...
			$mobile_header_output .= wedding_logo( 'logo-left', 'mobile-logo' );
...
if ( ! function_exists( 'wedding_mobile_cart_wrapper' ) ) {



	function wedding_mobile_cart_wrapper() {
	...
	add_action( 'wedding_before_page_wrapper', 'wedding_mobile_cart_wrapper', 30 );
...
if ( ! function_exists( 'wedding_mobile_search_wrapper' ) ) {



	function wedding_mobile_search_wrapper() {
		...
		if( isset( $mobile_show_search ) && $mobile_show_search == 1 ) {
        	...
        	echo '<input type="text" value="" name="s" class="form-control" placeholder="'. esc_html__('Enter text to search', 'wedding') .'" />'; 
	...
	add_action( 'wedding_before_page_wrapper', 'wedding_mobile_search_wrapper', 40 );
...
if ( ! function_exists( 'wedding_language_flags' ) ) {



	function wedding_language_flags() {
...
if ( ! function_exists( 'wedding_header_top_anchor' ) ) {



	function wedding_header_top_anchor() {
	...
	add_action( 'wedding_header_wrapper_start', 'wedding_header_top_anchor', 30 );
...
if ( ! function_exists( 'wedding_page_slider_wrapper' ) ) {



	function wedding_page_slider_wrapper() {
		...
		if( WEDDING_REVSLIDER_ACTIVE && isset( $rev_slider ) && $rev_slider != '' ) {
...
if ( ! function_exists( 'wedding_featured_post_slider' ) ) {



	function wedding_featured_post_slider() {
		...
		if( is_home() ) { 
			...
			if( wedding_get_theme_option( 'zozo_show_blog_featured_slider' ) == 1 ) {
		...
		elseif( ( ( is_archive() || is_tag() || is_category() ) && ! is_post_type_archive() ) ) { 
			...
			if( wedding_get_theme_option( 'zozo_show_archive_featured_slider' ) == 1 ) {
...
if ( ! function_exists( 'wedding_zmm_wrapper' ) ) {



	function wedding_zmm_wrapper() {
		...
		<div class="zmm-wrapper">
			...
			<div class="zmm-inner">
				...
				<?php 
					...
					$mobile_social 	= wedding_get_theme_option( 'mobile_social_icons' );
					...
					echo wedding_display_social_icons();
	...
	add_action( 'wedding_before_page_wrapper', 'wedding_zmm_wrapper', 10 );
