...
class wedding_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if( class_exists( 'Wedding_Walker_Nav_Menu_Edit' ) ){
	...
	public static function fallback( $args ) {
		...
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">'. esc_html__( 'Add a menu', 'wedding' ) .'</a></li>';
