				...
				<div id="primary" class="content-area <?php wedding_primary_content_classes(); ?>">
					...
					<div id="content" class="site-content">	
						...
						<?php if ( have_posts() ):
							...
							$theme_fields 	= array('socials' 		=> wedding_get_theme_option( 'zozo_blog_social_sharing' ),



													'author_info' 	=> wedding_get_theme_option( 'zozo_blog_author_info' ),



													'comments' 		=> wedding_get_theme_option( 'zozo_blog_comments' ),



													'related' 		=> wedding_get_theme_option( 'zozo_show_related_posts' ),



													'navigation' 	=> wedding_get_theme_option( 'zozo_blog_prev_next' ),
							...
							if( isset( $gallery_images_type ) && ( $gallery_images_type == '' || $gallery_images_type == 'default' ) ) {
								...
								$options_gallery_type = wedding_get_theme_option( 'zozo_single_blog_carousel' );
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<div class="post-inner-wrapper">
									...
									<?php if( ! wedding_get_theme_option( 'zozo_blog_post_featured_image' ) ): ?>



										<?php echo wedding_output_blog_post_slider( $post->ID, 'wedding-blog-large', $gallery_images_type ); ?>
									...
									<?php } else { ?>
										...
										<div class="entry-meta-wrapper">
											...
											<ul class="entry-meta">
												...
												<?php if( ! wedding_get_theme_option( 'zozo_blog_post_meta_author' ) ): ?>
												...
												<?php if( ! wedding_get_theme_option( 'zozo_blog_post_meta_date' ) ): ?>
												...
												<?php if( ! wedding_get_theme_option( 'zozo_blog_post_meta_categories' ) ): ?>
												...
												<?php if( ! wedding_get_theme_option( 'zozo_blog_post_meta_comments' ) ): ?>
													...
													<?php if ( comments_open() ) { ?>
														...
														<li class="comments-link"><i class="simple-icon icon-bubbles"></i><?php comments_popup_link( '<span class="leave-reply">' . esc_html__( '0 Comments', 'wedding' ) . '</span>', esc_html__( '1 Comments', 'wedding' ), esc_html__( '% Comments', 'wedding' ) ); ?>
											...
											<?php if( has_tag() ) { ?>
												...
												<div class="col-md-6">
													...
													<?php if( $post_values['socials'] == 'show' || $post_values['socials'] == 1 ) {
														...
														wedding_display_social_sharing_icons();
