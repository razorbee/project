										...
										<div class="entry-content">
											...
											<div class="row">
												...
												<div class="col-md-8">
													...
													$event_full_img = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'wedding-custom-single'); 
												...
												<div class="col-md-4 event-details">
													...
													<h3><?php echo esc_html__( 'Event Details', 'wedding'); ?></h3>
													...
													<?php if( isset( $event_google_map ) && $event_google_map != '' ) {
																...
																<div class="gmap-wrapper">
																	...
																	<div class="gmap_canvas" data-marker="<?php echo esc_url( WEDDING_THEME_URL . '/images/map-marker.png' ); ?>" data-address="<?php echo esc_attr( $event_google_map ); ?>" data-title="<?php echo esc_html( get_the_title() ); ?>" data-content="" style="width:600px; height:300px;">
													...
													<h3><?php echo esc_html__( 'Register Now', 'wedding'); ?></h3>
