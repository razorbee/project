...
if( wedding_get_theme_option( 'zozo_custom_scheme_color' ) != '' ) {
	...
	$custom_color_rgb = wedding_hex2rgb( $custom_color );
	$custom_color_dark = wedding_color_luminance( $custom_color, '-0.2' );
...
$custom_color_skin_hover = wedding_get_theme_option( 'zozo_custom_color_skin' );
...
// Link Color
$link_color_opt = wedding_get_theme_option( 'zozo_link_color' );
...
// Body Stylings 
$body_font_styles = '';
$body_font_opt = wedding_get_theme_option( 'zozo_body_font' );
if( $body_font_opt  ) {
...
$header_top_bg_opt = wedding_get_theme_option( 'zozo_header_top_background_color' );
...
$header_spacing_opt = wedding_get_theme_option( 'zozo_header_spacing' );
// Header Spacing
...
$header_styles = '';
$header_bg_opt = wedding_get_theme_option( 'zozo_header_bg_image' );
...
$sticky_styles = '';
$sticky_bg_opt = wedding_get_theme_option( 'zozo_sticky_bg_image' );
...
$sticky_logo_opt = wedding_get_theme_option( 'zozo_logo' );
...
// Main Site Width
$fullwidth_site_width = wedding_get_theme_option( 'zozo_fullwidth_site_width' );
$boxed_site_width = wedding_get_theme_option( 'zozo_boxed_site_width' );
if( wedding_get_theme_option( 'zozo_theme_layout' ) == 'fullwidth' ) {
...
// Dropdown Menu Width
$sub_menu_width = '';
$sub_menu_width_opt = wedding_get_theme_option( 'zozo_dropdown_menu_width' );
...
$footer_styles = '';
$footer_bg_opt = wedding_get_theme_option( 'zozo_footer_bg_image' );
...
$footer_spacing_opt = wedding_get_theme_option( 'zozo_footer_spacing' );
...
$footer_bar_styles = '';
$footer_copy_bg_opt = wedding_get_theme_option( 'zozo_footer_copy_bg_image' );
...
$footer_copy_spacing_opt = wedding_get_theme_option( 'zozo_footer_copyright_spacing' );
...
// H1 Styles
$h1_styles = '';
$h1_font_opt = wedding_get_theme_option( 'zozo_h1_font_styles' );
if( $h1_font_opt ) {
...
// H2 Styles
$h2_styles = '';
$h2_font_opt = wedding_get_theme_option( 'zozo_h2_font_styles' );
if( $h2_font_opt ) {
...
// H3 Styles
$h3_styles = '';
$h3_font_opt = wedding_get_theme_option( 'zozo_h3_font_styles' );
if( $h3_font_opt ) {
...
// H4 Styles
$h4_styles = '';
$h4_font_opt = wedding_get_theme_option( 'zozo_h4_font_styles' );
if( $h4_font_opt ) {
...
// H5 Styles
$h5_styles = '';
$h5_font_opt = wedding_get_theme_option( 'zozo_h5_font_styles' );
if( $h5_font_opt ) {
...
// H6 Styles
$h6_styles = '';
$h6_font_opt = wedding_get_theme_option( 'zozo_h6_font_styles' );
if( $h6_font_opt ) {
...
$topnav_styles = '';
$topnav_font_opt = wedding_get_theme_option( 'zozo_top_menu_font_styles' );
if( $topnav_font_opt ) {
...
$topnav_hv_styles = '';
$topnav_hv_opt = wedding_get_theme_option( 'zozo_top_menu_hcolor' );
...
$menu_font_styles = '';
$menu_font_opt = wedding_get_theme_option( 'zozo_menu_font_styles' );
if( $menu_font_opt ) {
...
$menu_hv_styles = '';
$menu_hv_opt = wedding_get_theme_option( 'zozo_main_menu_hcolor' );
...
$submenu_styles = '';
$submenu_font_opt = wedding_get_theme_option( 'zozo_submenu_font_styles' );
if( $submenu_font_opt ) {
...
$submenu_bg_styles = '';
if ( wedding_get_theme_option( 'zozo_submenu_bg_color' ) ) {
	$submenu_bg_styles .= 'background-color: '. wedding_get_theme_option( 'zozo_submenu_bg_color' ) .' !important;';
}
if( wedding_get_theme_option( 'zozo_submenu_show_border' ) == 1 ) {
	$submenu_border_opt = wedding_get_theme_option( 'zozo_main_submenu_border' );
...
if( wedding_get_theme_option( 'zozo_submenu_show_border' ) == 0 ) {
...
$submenu_hcolor_opt = wedding_get_theme_option( 'zozo_sub_menu_hcolor' );
$submenu_hbgcolor_opt = wedding_get_theme_option( 'zozo_submenu_hbg_color' );
...
// Title Font Stylings
$title_styles = '';
$single_post_title_font_opt = wedding_get_theme_option( 'zozo_single_post_title_fonts' );
...
$archive_styles = '';
$post_title_font_opt = wedding_get_theme_option( 'zozo_post_title_font_styles' );
...
$widget_title_styles = '';
$widget_title_font_opt = wedding_get_theme_option( 'zozo_widget_title_fonts' );
...
$widget_text_styles = '';
$widget_text_font_opt = wedding_get_theme_option( 'zozo_widget_text_fonts' );
...
$footer_widget_title_font_opt = wedding_get_theme_option( 'zozo_footer_widget_title_fonts' );
...
$footer_widget_text_font_opt = wedding_get_theme_option( 'zozo_footer_widget_text_fonts' );
...
// Logo Spacing
$logo_styles = '';
$logo_maxheight_opt = wedding_get_theme_option( 'zozo_logo_maxheight' );
$logo_padding_opt = wedding_get_theme_option( 'zozo_logo_padding' );
...
$logo_sticky_styles = '';
$sticky_logo_padding_opt = wedding_get_theme_option( 'zozo_sticky_logo_padding' );
...
$menu_lheight_styles = '';
$menu_height = '';
$menu_height_opt = wedding_get_theme_option( 'zozo_menu_height' );
...
$logo_bar_height = '';
$logo_bar_height_opt = wedding_get_theme_option( 'zozo_logo_bar_height' );
...
$menu_height_alt = '';
$menu_height_alt_opt = wedding_get_theme_option( 'zozo_menu_height_alt' );
...
$social_bg_color_opt = wedding_get_theme_option( 'zozo_social_bg_color' );
...
// Social Link Colors
$zozo_social_icon_color = wedding_get_theme_option( 'zozo_social_icon_color' );
