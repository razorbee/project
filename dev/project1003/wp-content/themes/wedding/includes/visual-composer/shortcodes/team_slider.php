 ...
 */
if ( ! function_exists( 'wedding_vc_team_slider_shortcode' ) ) {
	function wedding_vc_team_slider_shortcode( $atts, $content = NULL ) {
			...
			$output .= '<div id="zozo-team-slider'.$team_id.'" class="zozo-owl-carousel owl-carousel team-carousel-slider"'.$data_attr.'>';
				...
				while ($team_query->have_posts()) : $team_query->the_post();
					...
					if( isset( $member_style ) && $member_style == 'style_two' ) {
						$team_image 	= wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'wedding-blog-thumb');
...
if ( ! function_exists( 'wedding_vc_team_slider_shortcode_map' ) ) {
	function wedding_vc_team_slider_shortcode_map() {
				
		vc_map( 
			array(
				"name"					=> esc_html__( "Team Slider", "wedding" ),
				"description"			=> esc_html__( "Show your team in Slider.", 'wedding' ),
...
add_action( 'vc_before_init', 'wedding_vc_team_slider_shortcode_map' );