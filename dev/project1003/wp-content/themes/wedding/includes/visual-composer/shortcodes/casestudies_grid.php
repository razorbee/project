...
if ( ! function_exists( 'wedding_vc_casestudies_grid_shortcode' ) ) {



	function wedding_vc_casestudies_grid_shortcode( $atts, $content = NULL ) {
		...
		if( $casestudies_query->have_posts() ) {
			...
			if( isset( $pagination ) && $pagination == 'yes' ) {
				...
				$output .= wedding_pagination( $casestudies_query->max_num_pages, '' );
...
if ( ! function_exists( 'wedding_vc_casestudies_grid_shortcode_map' ) ) {



	function wedding_vc_casestudies_grid_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Case Studies Grid", "wedding" ),



				"description"			=> esc_html__( "Show your case studies in grid.", 'wedding' ),
				...
				"params"				=> array(					
					...
					array(
						...
						"heading"		=> esc_html__( "Case studies Columns", "wedding" ),
						...
						"description" 	=> esc_html__( "Select Columns type for Case Studies", "wedding" ),
...
add_action( 'vc_before_init', 'wedding_vc_casestudies_grid_shortcode_map' );