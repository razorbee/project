...
if ( ! function_exists( 'wedding_vc_testimonials_grid_shortcode' ) ) {



	function wedding_vc_testimonials_grid_shortcode( $atts, $content = NULL ) {
		...
		if( $testimonial_query->have_posts() ) {
					...
					$output .= '<div class="testimonial-item '.$column_class.' text-'.$text_align.'">';
						...
						if( isset( $text_align ) && $text_align == 'center' ) { 
							...
							$output .= '<div class="testimonial-content">';						
								...
								$output .= '<blockquote><p>'. wedding_shortcode_stripped_excerpt( get_the_content(), 35 ) .'</p></blockquote>';
			...
			if( isset( $pagination ) && $pagination == 'yes' ) {
				...
				$output .= wedding_pagination( $testimonial_query->max_num_pages, '' );
...
if ( ! function_exists( 'wedding_vc_testimonials_grid_shortcode_map' ) ) {



	function wedding_vc_testimonials_grid_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Testimonials Grid", "wedding" ),



				"description"			=> esc_html__( "Show your testimonials in Grid.", 'wedding' ),
				...
				"params"				=> array(
					...
					array(
						...
						"heading"		=> esc_html__( "Testimonial Columns", "wedding" ),
...
add_action( 'vc_before_init', 'wedding_vc_testimonials_grid_shortcode_map' );