...
if ( ! function_exists( 'wedding_vc_event_grid_shortcode' ) ) {



	function wedding_vc_event_grid_shortcode( $atts, $content = NULL ) {
		...
		if( $event_query->have_posts() ) {
			...
			while($event_query->have_posts()) : $event_query->the_post();
				...
				$event_img_mid = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'wedding-team');
						...
						$output .= '<div class="col-md-3 '. esc_attr( $push_class ) .'">';
...

							{
								...
								$output .= '<div class="event-item-img">';
									...
									$output .= '<img class="img-responsive" src="'. esc_url( WEDDING_THEME_URL . '/images/empty.jpg' ) .'" alt="'. esc_html( get_the_title() ) .'" />';
			...
			if( isset( $pagination ) && $pagination == 'yes' ) {
				...
				$output .= wedding_pagination( $event_query->max_num_pages, '' );
...
if ( ! function_exists( 'wedding_vc_event_grid_shortcode_map' ) ) {



	function wedding_vc_event_grid_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Event", "wedding" ),



				"description"			=> esc_html__( "Show your event by different styles.", 'wedding' ),
				...
				"params"				=> array(					
					...
					array(
						...
						"value"			=> array(
							...
							esc_html__( "Grid", "wedding" )		=> "grid" ,



							esc_html__( "List", "wedding" )		=> "list" ),
					...
					array(
						...
						"value"			=> array(
							...
							esc_html__( "ASC", "wedding" )		=> "ASC",



							esc_html__( "DESC", "wedding" )		=> "DESC",							
...
add_action( 'vc_before_init', 'wedding_vc_event_grid_shortcode_map' );