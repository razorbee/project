...
if ( ! function_exists( 'wedding_vc_twitter_slider_shortcode' ) ) {



	function wedding_vc_twitter_slider_shortcode( $atts, $content = NULL ) {
		...
		if( $screen_name && $consumer_key && $consumer_secret && $access_token && $access_token_secret && $twitter_count ) {
            ...
            $output .= '<p>' . esc_html__('Please configure twitter options.', 'wedding') . '</p>';
...
if ( ! function_exists( 'wedding_vc_twitter_slider_shortcode_map' ) ) {



	function wedding_vc_twitter_slider_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Twitter Slider", "wedding" ),



				"description"			=> esc_html__( "Show your twitter feeds in Slider.", 'wedding' ),
				...
				"params"				=> array(
					...
					array(
						...
						"heading"		=> esc_html__( "Consumer Key", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Consumer Secret", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Access Token", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Access Token Secret", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Twitter Screen Name", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Number of Tweets", "wedding" ),
...
add_action( 'vc_before_init', 'wedding_vc_twitter_slider_shortcode_map' );