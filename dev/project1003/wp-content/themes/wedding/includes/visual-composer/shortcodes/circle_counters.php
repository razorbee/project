...
if ( ! function_exists( 'wedding_vc_circle_counter_shortcode' ) ) {



	function wedding_vc_circle_counter_shortcode( $atts, $content = NULL ) {
...
if ( ! function_exists( 'wedding_vc_circle_counters_shortcode_map' ) ) {



	function wedding_vc_circle_counters_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Pie Chart", "wedding" ),



				"description"			=> esc_html__( "Animated Circle Pie Chart with Counters.", 'wedding' ),
				...
				"params"				=> array(
					...
					array(
						...
						"value"			=> array(
							...
							esc_html__( "3 Columns", "wedding" )	=> "3",



							esc_html__( "4 Columns", "wedding" )	=> "4",



							esc_html__( "5 Columns", "wedding" )	=> "5" ),
					...
					array(
						...
						'heading'		=> esc_html__( 'Circle Size', "wedding" ),
					...
					array(
						...
						'heading'		=> esc_html__( 'Circle Line Width', "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Graphic Values", "wedding" ),
						...
						"description" 	=> esc_html__( "Input graph values, titles, description and bar color, track color here. Divide values with linebreaks (Enter). Example: 90|Development|Your Description|#0099cc|#ffffff", "wedding" ),



						"group"			=> esc_html__( "Pie Chart", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Description Color", "wedding" ),
...
add_action( 'vc_before_init', 'wedding_vc_circle_counters_shortcode_map' );