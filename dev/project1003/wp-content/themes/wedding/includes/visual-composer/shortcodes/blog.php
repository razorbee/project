...
if ( ! function_exists( 'wedding_vc_blog_shortcode' ) ) {



	function wedding_vc_blog_shortcode( $atts, $content = NULL ) { 
			...
			$output = '<div id="zozo-blog-posts-container" class="zozo-blog-posts-wrapper zozo-isotope-grid-system'.$main_classes.'">';
				...
				while($blog_query->have_posts()) : $blog_query->the_post();
					...
					if( isset( $layout ) && ( $layout == 'large' || $layout == 'list' ) ) {
						...
						$output .= wedding_output_blog_large_layout( $post_id, $post_class, $image_size, $excerpt_limit, $meta_array, $layout );
						...
						$output .= wedding_output_blog_grid_layout( $post_id, $post_class, $image_size, $excerpt_limit, $meta_array, $animation );
				...
				if( $pagination != "hide" ) {
					...
					$output .= wedding_pagination( $blog_query->max_num_pages, $scroll_type );
...
if ( ! function_exists( 'wedding_vc_blog_shortcode_map' ) ) {



	function wedding_vc_blog_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Blog", "wedding" ),



				"description"			=> esc_html__( "Show your blog posts in different styles.", 'wedding' ),
				...
				"params"				=> array(					
					...
					array(
						...
						"heading"		=> esc_html__( "Blog Layout", "wedding" ),
						...
						"group"			=> esc_html__( "Layout", "wedding" ),
						...
						"value"			=> array(
							...
							esc_html__( "Large Layout", "wedding" )		=> "large",



							esc_html__( "List Layout", "wedding" )		=> "list",



							esc_html__( "Grid Layout", "wedding" )		=> "grid" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Blog Columns", "wedding" ),
						...
						"value"			=> array(
							...
							esc_html__( "2 Columns", "wedding" )		=> "two",



							esc_html__( "3 Columns", "wedding" )		=> "three",



							esc_html__( "4 Columns", "wedding" )		=> "four" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Excerpt Limit", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Hide Thumbnail", "wedding" ),
						...
						"value"			=> array(
							...
							esc_html__( "No", "wedding" )	=> 0,



							esc_html__( "Yes", "wedding" )	=> 1 ),
					...
					array(
						...
						"heading"		=> esc_html__( "Hide Author", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Hide Comments", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Hide Date", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Hide Categories", "wedding" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Hide Read More Link", "wedding" ),
					...
					array(
						...
						"value"			=> array(
							...
							esc_html__( "Hide", "wedding" )				=> "hide",



							esc_html__( "Pagination", "wedding" )		=> "pagination",



							esc_html__( "Infinite Scroll", "wedding" )	=> "infinite" ),
...
add_action( 'vc_before_init', 'wedding_vc_blog_shortcode_map' );