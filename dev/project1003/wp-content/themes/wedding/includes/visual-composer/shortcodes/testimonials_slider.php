...
if ( ! function_exists( 'wedding_vc_testimonials_slider_shortcode' ) ) {



	function wedding_vc_testimonials_slider_shortcode( $atts, $content = NULL ) {
			...
			$output .= '<div id="zozo-testimonial-slider'.$testimonials_id.'" class="zozo-owl-carousel owl-carousel testimonial-carousel-slider"'.$data_attr.'>';
				...
				while ($testimonial_query->have_posts()) : $testimonial_query->the_post();
					...
					if( isset( $style ) && $style == 'style-3' ) {
						...
						$testi_img = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'wedding-testimonial-slider');

					}else{

						$testi_img = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'wedding-blog-thumb');
							...
							$output .= '<div class="testimonial-client-quote">';
								...
								$output .= '<div class="testimonial-content">';
									...
									if( isset( $testi_desc_type ) && $testi_desc_type == 'full_content' ) {
										...
										$output .= '<blockquote><p>'. wedding_shortcode_stripped_excerpt( get_the_content(), $excerpt_limit ) .'</p></blockquote>';
...
if ( ! function_exists( 'wedding_vc_testimonials_slider_shortcode_map' ) ) {



	function wedding_vc_testimonials_slider_shortcode_map() {
		...
		vc_map( 
			...
			array(
				...
				"name"					=> esc_html__( "Testimonials Slider", "wedding" ),



				"description"			=> esc_html__( "Show your testimonials in Slider.", 'wedding' ),
				...
				"params"				=> array(
					...
					array(
						...
						"heading"		=> esc_html__( "Testimonial Style", "wedding" ),
						...
						"value"			=> array(
							...
							esc_html__( 'Default Style', 'wedding' ) 	=> "default",



							esc_html__( 'Style 1', 'wedding' ) 		=> "border",



							esc_html__( 'Style 2', 'wedding' ) 		=> "border2",



							esc_html__( 'Style 3', 'wedding' ) 		=> "style-3" ),
					...
					array(
						...
						"heading"		=> esc_html__( "Testimonial Description Type", "wedding" ),
...
add_action( 'vc_before_init', 'wedding_vc_testimonials_slider_shortcode_map' );