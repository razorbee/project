...
if( wedding_get_theme_option( 'zozo_custom_css' ) != '' ) {



	echo wedding_get_theme_option( 'zozo_custom_css' );
...
$body_bg_img_opt = wedding_get_theme_option( 'zozo_body_bg_image' );
...
if( isset( $body_bg_opacity ) && $body_bg_opacity != 0 ) {
	...
	$body_rgb_color = wedding_hex2rgb( $body_bg_color );
...
$header_bg_img_opt = wedding_get_theme_option( 'zozo_header_bg_image' );
...
if( isset( $header_bg_opacity ) && $header_bg_opacity != 0 ) {
	...
	$header_rgb_color = wedding_hex2rgb( $header_bg_color );
...
$page_bg_img_opt = wedding_get_theme_option( 'zozo_page_bg_image' );
...
if( isset( $page_bg_opacity ) && $page_bg_opacity != 0 ) {
	...
	$page_rgb_color = wedding_hex2rgb( $page_bg_color );
...
if( $page_title_border == ''  ) {
	...
	$page_title_border = wedding_get_theme_option( 'zozo_page_title_border_color' );	
...
if( $page_title_bg_color == ''  ) {
	...
	$page_title_bg_color = wedding_get_theme_option( 'zozo_page_title_background_color' );	
...
if( !$page_title_bg_full  ) {
	...
	$page_title_bg_full = wedding_get_theme_option( 'zozo_page_title_scale_bg_image' );	
...
if( isset( $page_title_bar_bg_repeat ) && $page_title_bar_bg_repeat == '' || $page_title_bar_bg_repeat == 'default' ) {
	...
	$page_title_bar_bg_repeat = wedding_get_theme_option( 'zozo_page_title_background_image_repeat' );	
...
if( isset( $page_title_bg_parallax ) && $page_title_bg_parallax == '' || $page_title_bg_parallax == 'default' ) {
	...
	$page_title_bg_parallax = wedding_get_theme_option( 'zozo_page_title_parallax_bg_image' );
...
if( $page_title_height == ''  ) {
	...
	$page_title_height = wedding_get_theme_option( 'zozo_page_title_bar_height' );	
...
if( $page_title_mobile_height == ''  ) {
	...
	$page_title_mobile_height = wedding_get_theme_option( 'zozo_page_title_bar_mobile_height' );	
...
if( $page_title_color == ''  ) {
	...
	$page_title_color = wedding_get_theme_option( 'zozo_page_title_color' );	
...
if( $page_breadcrumbs_color == ''  ) {
	...
	$page_breadcrumbs_color = wedding_get_theme_option( 'zozo_page_title_breadcrumbs_color' );	
...
if( isset( $theme_layout ) && $theme_layout == '' ) {
	...
	$theme_layout = wedding_get_theme_option( 'zozo_theme_layout' );
...
if( isset( $header_vertical_position ) && $header_vertical_position == '' || $header_vertical_position == 'default' ) {
	...
	$header_vertical_position = wedding_get_theme_option( 'zozo_header_vertical_position' );
...
$header_side_width_opt = wedding_get_theme_option( 'zozo_header_side_width' );
