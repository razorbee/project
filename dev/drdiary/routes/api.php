...
Route::get('/data-table/all-template','ApiController@allTemplateToDataTable')->name('template.datatable');
Route::get('/data-table/all-prescription','ApiController@allPrescriptionToDataTable');
