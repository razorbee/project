    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6 col-xl-4">
            <div class="widget-panel widget-style-2 bg-white">
                ...
                <h2 class="m-0 text-dark counter font-600">
                    <?php echo e(count(\App\Model\Prescription::all())); ?>
        ...
        <div class="col-md-6 col-lg-6 col-xl-4">
            <div class="widget-panel widget-style-2 bg-white">
                ...
                <h2 class="m-0 text-dark counter font-600">
                    <?php echo e(\App\Model\PatientPayment::where('updated_at','like',\Carbon\Carbon::today().'%')->sum('payment')); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Latest Prescriptions <span id="countPrescription"></span> <small style="font-size: 12px;" class="pull-right">last 7 days</small> </h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Latest Appointment <span id="countAppointment"></span> <small style="font-size: 12px;" class="pull-right">last 7 days</small></h4>
                </div>
                <div class="card-body">
                    <table width="100%" class="table">
...
<?php $__env->startSection('extra-js'); ?>
    <script>
        $(document).ready(function () {
            // Get Total Patient
             $.get('<?php echo e(url('/api/total-patient')); ?>',function (data) {
                 console.log(data);
                 $("#total_patient").text(data);
             });

            $.get('<?php echo e(url('/api/todays-patient')); ?>',function (data) {
                console.log(data);
                $("#todays_patient").text(data);
            });

            $.get('<?php echo e(url('/api/latest-patient')); ?>',function (data) {
                console.log(data);
                $("#patient_latest").text(data);
            });

            $.get('<?php echo e(url('/api/latest-prescription')); ?>',function (data) {
                console.log(data);
            ...
            $.get('<?php echo e(url('/api/latest-appointment')); ?>',function (data) {
                console.log(data);
