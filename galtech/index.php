...
<!--
              <ul>
                ...
                <li>
                  <i class="fa fa-check"></i> Value to our OEM Partners through increased reach & market growth.
                </li>
                <li>
                  <i class="fa fa-check"></i> Value to our employees by providing a world class working environment.
                </li>
                <li>
                  <i class="fa fa-check"></i> Value to our Clients.
                </li>
                <li>
                  <i class="fa fa-check"></i> Value to our employees by providing a world class working environment.
                </li>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline services-head text-center">
            <h2>Our Products</h2>
              <p>We have been in the forefront of bringing the latest Digital Technology products in Office Automation & Information Technology to our esteemed customers. We bring to you the latest state of the art products by partnering with global leaders in the respective domains. Please find below our wide range of Products.</p>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="contact-icon text-center">
              <div class="single-icon">
                ...
                <p>
                  Email: response@galtechinfo.com<br>
                  <span>Web: www.galtech.com</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="contact-icon text-center">
              <div class="single-icon">
                ...
                <p>
                  No.50, 9th A Main Road, 1st Stage,<br>Indiranagar, Bangalore - 560 038.
