...
-->
        ...
        <a href="#"> <img src="img/5518A-6518A-7518A-8518A.jpg" onclick="openModal();currentSlide(4)" class="hover-shadow cursor"></a>
...
<div id="myModal" class="modal" style="z-index:10;">
  ...
  <div class="modal-content">
    ...
    <a class="next" onclick="plusSlides(1)" style="background-color:#000000;">&#10095;</a>
