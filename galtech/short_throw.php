...
<div class="container-fluid">
  ...
  -webkit-filter: blur(1px);margin-top:100px;">
       <div class="hero-text">
    <h1 style="color:black">Short Throw</h1>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="btn-group btn-breadcrumb breadcrumb-default">
           ...
           <div class="btn btn-default visible-xs-block hidden-xs visible-sm-block ">...</div>
            <div class="btn btn-info"><b>Short Throw</b></div>
        </div>
	</div>
</div>
...
<div class="container">
<div class="row">
<h3 class="product_under" style="text-align:center;">Short Throw</h3>
  </div> 
<div class="row">
...
<!--4 BEGINS-->           
<div class="col-md-4 col-sm-6 col-xs-12" style="margin-left:370px;">
...
<h3 class="product_under" style="text-align:center;">UltraShort Throw & Interactive</h3>
  </div>          
<!--5 BEGINS-->      
    <div class="row">
